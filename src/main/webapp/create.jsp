            ...
            <form action="/miraclebird/party/create" method="post">
                <table class="party">
                    <tbody>
                        ...
                        <div class="dropdownP">
                            <tr>
                                <td><img src="${pageContext.request.contextPath}/resources/img/time.png" class = "img" /></td>
                                <td><a>TIME</a></td>
                                <td>
                        ...
                        <tr>
                            <td><img src="${pageContext.request.contextPath}/resources/img/profile-2user.png" class="img" /></td>
                            <td><a>PEOPLE</a></td>
                            <td><input name="maxMemberCount" class="inputBox" placeholder="파티 인원을 입력해주세요."></td>
                        </tr>
                        <tr>
                            <td><img src="${pageContext.request.contextPath}/resources/img/medal.png" class="img" /></td>
                            <td><a>WELCOME</a></td>
