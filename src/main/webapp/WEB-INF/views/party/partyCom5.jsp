...
<link
	href="${pageContext.request.contextPath}/resources/css/partyCom5.css"
...
<body>
	...
	<div>
		<div class="cate">
			...
			</a> <a href="/miraclebird/party/feed?page=1">
				<button class="btn">Feed</button>
			</a> <a href="/miraclebird/party/community">
				<button class="btn" id="here" onload="backChange()"
					style="background-color: #ffb100">Community</button>
			</a> <a href="/miraclebird/party/members">
