...
<link
	href="${pageContext.request.contextPath}/resources/css/partyStyle5.css"
					...
					<div class="content">
						<div class="container">
							<div class="image-upload" id="image-upload">
								...
								<form action="/miraclebird/party/img/update" method="post"
									enctype="multipart/form-data">
									<div class="button">
										<label for="chooseFile"
											style="font-weight: bold; font-size: 20px;"> Party
											Image Change </label>
									</div>
									...
									<div class="fileContainer">
										...
										<div class="buttonContainer">
											<div class="submitButton" id="submitButton">
												<button type="submit"
													style="background-color: #FFb100; border: none; color: white; font-weight: bold;">SUBMIT</button>
											</div>
										</div>
									</div>
								</form>
