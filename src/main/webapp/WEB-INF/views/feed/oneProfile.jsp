...
<%-- <div class="profile-inner">
	...
	<div class="edit-profile">
		<a href="profile.jsp"> <!-- 로그인 한 유저가 아닐 경우(본인의 프로필이 아닌 경우) 버튼 숨김 -->
			<div>프로필 수정</div>
		</a>
	</div>
	...
	<div class="number">
		...
		<div class="time">
			<span class="content">${profileVo.miracleStartTime } ~
				${profileVo.miracleEndTime }</span> <span class="sub-title">Time</span>
		</div>
	</div>
